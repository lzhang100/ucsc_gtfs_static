...
class Stoptimes{
	...
	public static void main (String args[]){
		...
		//Create pointer to stop_times.txt to be written later
	
		File toOutput= new File(args[0]);
		PrintWriter printOutput = null;
	
		//Open the stop_times.txt		
		try{
		...
		//Create stop_times sequences for LoopO Route
		int tripnumber = 0;
		...
		//Create stop_times sequences for Loopin Route
		tripnumber = 0;
		...
		//Create stop_times sequences for inUC Route
		tripnumber = 0;
		...
		//Create stop_times sequences for OUtUC Route
		tripnumber = 0;
		...
		//Create stop_times sequences for ENc Route
		tripnumber = 0;
		...
		//Create stop_times sequences for WNC Route
		tripnumber = 0;
	...
	public static int routeone_stoptimes(String trip, int tripnumber, String readfile, PrintWriter printOutput){
		...
		//Scan in the starting times of each trip and save it into the arraylist
		Scanner scan = null;
		try{
		...
		//Write to the stop_times.txt for each bus stop that the vehicle drops and picks up on the route. 
	...
	public static int routefive_stoptimes(String trip, int tripnumber, String readfile, PrintWriter printOutput){
		...
		//Manually add stop times for the the stops for trips that start at 24:00:00
		...
		for(int b=0; b<routefive.size(); b++){
			try{
				if(routefive.get(b).equals("24:00:00")){
					...
					//Manually add stop time for the quary plaza end stop to 24:00:00  if the trip starts at 23:30:00   
				...
				//Write to the file the stop_sequence
